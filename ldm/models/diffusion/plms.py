        ...
        def get_model_output(input):
            ...
            if uc is not None and guidance_scale != 1:
                unconditional_input = dict(x=input["x"], timesteps=input["timesteps"], context=uc, 
                                           inpainting_extra_input=input["inpainting_extra_input"], grounding_extra_input=input['grounding_extra_input'], 
                                           action_masks=input["action_masks"], object_masks=input["object_masks"], subject_masks=input["subject_masks"],
                                           action_masks_8=input["action_masks_8"], object_masks_8=input["object_masks_8"], subject_masks_8=input["subject_masks_8"],
                                           context_object = input["context_object"], context_subject = input["context_subject"],context_action = input["context_action"])
