...
class HICODataset(HOIBaseDataset):
    ...
    def __getitem__(self, index):
        ...
        for anno in annos:
            ...
            all_objects=anno["object"]
            all_actions=anno["action"]
            all_subjects=anno["subject"]
        ...
        # objects = [['']] * self.max_boxes_per_data
        # actions = [['']] * self.max_boxes_per_data
        # subjects = [['']] * self.max_boxes_per_data
        ...
        for i, idx in enumerate(wanted_idxs):
            ...
            # objects[i] = all_objects[idx]
            # actions[i] = all_actions[idx]
            # subjects[i] = all_subjects[idx]
        ...
        if all_objects is not None:
            out["object"] = all_objects

        if all_actions is not None:
            out["action"] = all_actions

        if all_subjects is not None:
            out["subject"] = all_subjects
    ...
    #             all_object_image_embeddings.append(self.mapping(anno["object_" + image_embedding_name]))
    #             all_action_image_embeddings.append(self.mapping(anno["action_" + image_embedding_name]))
    #             all_objects.append(anno["object"])
    #             all_actions.append(anno["action"])
    #             all_subjects.append(anno["subject"])
    ...
    #         object_image_embeddings[i] = all_object_image_embeddings[idx]
    #         action_image_embeddings[i] = all_action_image_embeddings[idx]
    #         # objects.append(all_objects[idx])
    #         # actions.append(all_actions[idx])
